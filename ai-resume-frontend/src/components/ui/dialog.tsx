...
>(({ className, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn("fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1000] bg-white/90 dark:bg-gray-900/90 text-gray-900 dark:text-white p-6 rounded-lg shadow-2xl w-[90%] max-w-lg transition-all", className)}
      {...props}
    />
  </DialogPortal>
));
